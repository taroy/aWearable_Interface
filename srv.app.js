...
/** 
  ...
  /** 
   * Catch request for serving about page - Ingrid
   */
  srv.all('/about.html', function(req, res) {
    res.render('about', {jsApp: 'none', active: 'about', title: 'noduino', 'examples': examples});
  });
  
   /** 
   * Catch request for serving about page - Ingrid
   */
  srv.all('/how_to.html', function(req, res) {
